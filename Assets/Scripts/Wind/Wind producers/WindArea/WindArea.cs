...
namespace Wind
{
    ...
    public class WindArea : WindProducer
    {
        ...
        protected override void OnEnable()
        {
            ...
            calcWindPointsShader.GetKernelThreadGroupSizes(calcWindPointsShaderKernel, out groupSize1D, out _, out _);
        ...
        */
        ...
        protected override ComputeBuffer CalcWindFieldPoints()
        {
            ...
            int numGroupsX = Mathf.Max(1, Mathf.CeilToInt(numCells.x * numCells.y * numCells.z / (float)groupSize1D));
