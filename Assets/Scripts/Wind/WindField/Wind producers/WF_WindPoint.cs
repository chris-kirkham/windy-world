...
public class WF_WindPoint
{
    ...
    public WF_WindPoint(Vector3 position, Vector3 wind, uint depth, WindProducerMode mode)
    {
    ...
    public WF_WindPoint(Vector3 position, Vector3 wind, int priority, uint depth, WindProducerMode mode)
    {
        this.position = position;
        this.wind = wind;
