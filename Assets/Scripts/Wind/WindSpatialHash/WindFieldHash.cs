 ...
 * a list of objects in that cell (must have HashObject script attached to them)</summary>
 */
public class WindFieldHash : MonoBehaviour
{
    ...
    private class Cell
    {
        ...
        public Cell(Vector3 wind, GameObject obj)
        {
            this.wind = wind;
        ...
        public Cell(Vector3 wind, List<GameObject> objs)
        {
            this.wind = wind;
            this.objs = objs;
            timeout = emptyTimeout;
    ...
    void Awake()
    {
        ...
        //add keys for initial cells and initialise corresponding empty cells 
    ...
    */
    ...
    public void AddByPoint(GameObject obj)
    {
        ...
        else
        {
            ...
            cells.Add(key, new Cell(Vector3.zero, obj));
        }
    }
